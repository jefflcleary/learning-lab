...
- A computer set up for coding, with git installed — established by
  `lessons/dev-machine-setup/` (git was installed there and has been waiting since)
...
people leaving each other messages, and this course itself reaches the learner as a
