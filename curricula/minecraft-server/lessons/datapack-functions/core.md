...
software; the shape of that bracket syntax will look familiar the day the course
reaches databases.

Worth saying plainly, since this lesson is the peak of what datapacks alone will do
in this course: functions react to the clock and to `/trigger` — but they can't
