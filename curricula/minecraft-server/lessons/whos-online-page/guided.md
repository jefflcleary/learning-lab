...
All course long, you've been the client. Your game was a client of your server.
...
product, and it's made out of every arc of this course at once: the ping protocol
...
worth knowing, and browsers are famously forgiving while you get it right.)
...
different door. That one line is most of this course's networking, collapsed.
...
- Genuinely open: what should a real server dashboard show that this page
  ...
  [the open part of the course](../../PATH.md).
