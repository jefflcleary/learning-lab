...
Write these down before writing any code — they are design decisions, and making
...
- Scores across rounds are easy while the bot runs — a variable does it. Now restart
  ...
  files — which a later part of this course makes real. Arriving early is allowed.
