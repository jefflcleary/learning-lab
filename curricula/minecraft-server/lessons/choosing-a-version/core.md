...
- A recorded decision (with reasoning) about which version(s) run, in the learner's
  copy of this repo
...
- Nearly all of this course is version-independent (settings, console, networking,
...
3. **Make the decision.** All three setups presented as legitimate with honest
   ...
   learner just arrived at. Decision + reasoning written into the learner's copy
   of the repo.
