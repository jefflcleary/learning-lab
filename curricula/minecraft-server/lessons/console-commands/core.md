...
this course, programs you write will compose exactly these strings and send them —
...
- What command do you *wish* existed that doesn't? Write it down and keep it —
  a surprising amount of this course is about making the server do things it has no
  command for.
