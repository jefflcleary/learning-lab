# Curriculum design — Running a Minecraft server

The arcs, their milestones, the status of every lesson, and this curriculum's own
...
- **Course tooling is never lesson content.** Whatever machinery renders, publishes,
  ...
  infrastructure and stays out of the curriculum entirely. Lessons teach against the
