...
The lessons here ask you to write two kinds of things down as you work: predictions
and walls. The place you write them is your logbook.

Keep it wherever suits you — a paper notebook, a notes app, or a plain text file on
your computer (once you have a projects folder, a file there works well). It belongs
to you, it's private, and no lesson ever asks you to put it anywhere public. What
matters is that it's one place, and that you actually write in it.
...
shrug. With one, it's evidence that something you believed isn't so — and now you
have a specific thing to find out. Lessons have a Predict section for exactly this;
the answers go here.
...
can feel like a verdict. Give this record a few months and it becomes a list of
