...
- **A machine set up for coding** — terminal and VS Code, from [Setting up a
  coding machine](../../../dev-machine/lessons/dev-machine-setup/guided.md). Quick check: you can `cd` into your
...
through bots. The work in this part of the module is data work, so we use the data
...
when [setting up this machine](../../../dev-machine/lessons/dev-machine-setup/guided.md) — just changed what your
