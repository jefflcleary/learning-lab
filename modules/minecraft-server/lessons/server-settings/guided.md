...
- **A code editor.** Set up in [Setting up a coding machine](../../../dev-machine/lessons/dev-machine-setup/guided.md).
...
Later in this module you'll learn to speak that conversation yourself, byte by byte.
...
- `level-seed` only affects terrain that hasn't been generated yet. So what happens
  ...
  it on a throwaway world — the result is worth seeing once.
