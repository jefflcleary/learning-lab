...
Write your answers in [your logbook](../../../../logbook.md) before touching anything:
...
1. **VS Code** — [code.visualstudio.com](https://code.visualstudio.com), download,
   unzip, drag into `Applications`. Open it once — macOS asks for confirmation the
   first time a downloaded app runs.
...
Everything you build in this module will live in one folder, and you're going to
