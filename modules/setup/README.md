...
around. This module gets a machine to that point.

It exists as its own module because the result isn't tied to any one project.
Whatever you go on to build — a game server, a website, a robot — starts from the
